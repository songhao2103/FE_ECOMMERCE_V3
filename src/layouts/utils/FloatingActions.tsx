...
import { LINK_MESSENGER } from "../../constances/network";
import { PHONE_NUMBER } from "../../constances/contact";
...
const FloatingActions = ({ onOpenForm }: { onOpenForm: () => void }) => {
      ...
      <AnimatePresence>
        {(isOpen || !isMobile) && (
          ...
          >
            ...
            <FloatingItem icon={PiQuestionMarkBold} onClick={onOpenForm} />
          </motion.div>
        )}
      </AnimatePresence>
