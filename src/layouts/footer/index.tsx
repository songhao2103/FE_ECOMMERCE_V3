import { EMAIL, PHONE_NUMBER } from "../../constances/contact";
import { LINK_FACEBOOK, LINK_MESSENGER } from "../../constances/network";
  ...
  return (
    <div className="bg-dark p-10 flex justify-center w-full mt-[50px] md:mt-[100px] xl:mt-[150px] flex-col lg:flex-row">
      <div className="flex max-w-[1820px] gap-x-[100px] flex-col lg:flex-row gap-y-6">
        <div className="flex flex-col items-center justify-center gap-y-6 lg:justify-start lg:items-start">
        ...
        <div className="flex flex-col gap-y-4">
          ...
          <div className="flex flex-col gap-y-2">
            ...
            <div className="flex items-center gap-x-3">
              ...
              <p className="text-sm text-gray-400">{PHONE_NUMBER}</p>
            </div>
          </div>
          <div className="flex items-center gap-x-4">
            ...
            <a href={LINK_MESSENGER} target="_blank" rel="noopener noreferrer">
              <div className="flex items-center justify-center w-8 h-8 bg-white rounded-full">
