...
export const PRICE_LIST: IPriceList[] = [
  ...
  { title: "Chi tiết một đơn hàng order", component: CostOfOrder, value: 3 },
  {
    title: "Phí đóng gỗ",
    component: TimberFee,
    value: 4,
...
export const COST_OF_ORDER_LIST: ICostOfOrder[] = [
  ...
  {
    name: "2. Phí dịch vụ",
    description: "Phí giao dịch mua hàng khách trả cho Trần Hoàng",
    required: true,
  },
  {
    name: "3. Phí ship Trung Quốc",
    description:
      "Phí chuyển hàng từ nhà cung cấp tới kho của Trần Hoàng tại Trung Quốc",
    required: true,
  },
  {
    name: "4. Phí vận chuyển",
    description:
      "Phí vận chuyển từ kho Trung Quốc về kho của Trần Hoàng tại Việt Nam (Đơn vị Kg)",
    required: true,
  },
  {
    name: "5. Phí kiểm đếm",
  ...
  },
  {
    ...
    description:
      "Là phí vận chuyển hàng từ kho của Trần Hoàng tại Việt Nam tới nhà của quý khách",
    required: false,
  },
];
