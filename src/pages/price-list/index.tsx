          ...
          <div className="w-full lg:w-[70%]">
            ...
            {priceListActive?.value === 3 && (
              <div className="flex flex-col mt-6 gap-y-1">
                ...
                <p>
                  1. Với những lô hàng số lượng lớn sẽ trao đổi và thỏa thuận
                </p>
                <p>
                  2. Hàng có cân nặng 300kg hoặc 3 khối trở lên 1 mã hàng sẽ
                  được miễn phí giao hàng nội thành Hà Nội, Đà Nẵng, Tp Hồ Chí
                  Minh
                </p>
                <p>
                  3. Đơn hàng không đủ điều kiện miễn phí giao hàng sẽ căn cứ
                  vào địa điểm giao hàng để báo cước giao hàng
                </p>
              </div>
            )}
          </div>
