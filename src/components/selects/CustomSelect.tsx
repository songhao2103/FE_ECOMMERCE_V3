...
const CustomSelect = <T,>({
  ...
  return (
    <div className="w-full">
      {label && (
        <label htmlFor={id} className={`font-normal block mb-1 ${labelStyle}`}>
      ...
      <div ref={ref} className="relative w-full">
        <button
          id={id}
          type="button"
          className="flex items-center justify-between w-full px-4 py-[10px] text-left border border-gray-300 rounded hover:border-gray-400"
          onClick={() => setOpen((o) => !o)}
        >
